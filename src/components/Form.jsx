                ...
                <div className="border shadow-lg bg-[#f2e2c7] border-[#5f4137] rounded-xl">
                  <div className="px-8 py-14">
                    <div className="text-center mb-6">
                      <h2 className="text-xl font-bold mb-2 text-[#126634]">
                        Get Early Access
                      </h2>
                      <p className="text-xs text-[#5f4137] max-w-[430px] mx-auto">
                    ...
                    <form onSubmit={handleSubmit} className="space-y-4">
                      <div className="flex flex-col gap-4 md:flex-row">
                        <input
                          ...
                          className="border bg-white border-[#5f4137] focus:outline-4 focus:outline-[#c7ada4] focus:border-none  text-black rounded-md px-3 py-2 flex-1 text-xs"
                          required
                        />
                      ...
                      <div className="relative">
                        <input
                          ...
                          className="w-full pr-10 border bg-white border-[#5f4137]  focus:outline-4 focus:outline-[#c7ada4] focus:border-none  text-black rounded-lg px-3 py-2 text-xs"
                          required
                        />
                        {isValidEmail && (
                      ...
                      <div>
                        ...
                        <input
                          ...
                          className="w-full border bg-white border-[#5f4137] focus:outline-4 focus:outline-[#c7ada4] focus:border-none  text-black rounded-md px-3 py-2 flex-1 text-xs"
                        />
                      </div>
